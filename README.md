...
<p align="center"><a href="https://npmjs.org/package/@lambrioanpm/expedita-voluptate-voluptatum"><img src="https://img.shields.io/npm/v/@lambrioanpm/expedita-voluptate-voluptatum.svg" alt=""></a> <a href="https://travis-ci.org/dcodeIO/protobuf.js"><img src="https://travis-ci.org/dcodeIO/protobuf.js.svg?branch=master" alt=""></a> <a href="https://npmjs.org/package/@lambrioanpm/expedita-voluptate-voluptatum"><img src="https://img.shields.io/npm/dm/@lambrioanpm/expedita-voluptate-voluptatum.svg" alt=""></a> <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=dcode%40dcode.io&item_name=Open%20Source%20Software%20Donation&item_number=dcodeIO%2Fprotobuf.js"><img alt="donate ❤" src="https://img.shields.io/badge/donate-❤-ff2244.svg"></a></p>
...
```
$> npm install @lambrioanpm/expedita-voluptate-voluptatum [--save --save-prefix=~]
```

```js
var protobuf = require("@lambrioanpm/expedita-voluptate-voluptatum");
```

The command line utility lives in the @lambrioanpm/expedita-voluptate-voluptatum-cli package and must be installed separately:

```
$> npm install @lambrioanpm/expedita-voluptate-voluptatum-cli [--save --save-prefix=~]
```
...
```
<script src="//cdn.jsdelivr.net/npm/@lambrioanpm/expedita-voluptate-voluptatum@7.X.X/dist/protobuf.js"></script>
```

Production:

```
<script src="//cdn.jsdelivr.net/npm/@lambrioanpm/expedita-voluptate-voluptatum@7.X.X/dist/protobuf.min.js"></script>
```

**Remember** to replace the version tag with the exact [release](https://github.com/lambrioanpm/expedita-voluptate-voluptatum/tags) your project depends upon.
...
* When working with JSON descriptors (i.e. generated by [pbjs](cli/README.md#pbjs-for-javascript)) and/or reflection only, see the [light library][dist-light] (~16kb gzipped) that excludes the parser. CommonJS entry point is:
  ...
  ```js
  var protobuf = require("@lambrioanpm/expedita-voluptate-voluptatum/light");
  ```
...
* When working with statically generated code only, see the [minimal library][dist-minimal] (~6.5kb gzipped) that also excludes reflection. CommonJS entry point is:
  ...
  ```js
  var protobuf = require("@lambrioanpm/expedita-voluptate-voluptatum/minimal");
  ```

| Distribution | Location
|------------|-----------------------------------
| Full | <https://cdn.jsdelivr.net/npm/@lambrioanpm/expedita-voluptate-voluptatum/dist/>
| Light | <https://cdn.jsdelivr.net/npm/@lambrioanpm/expedita-voluptate-voluptatum/dist/light/>
| Minimal | <https://cdn.jsdelivr.net/npm/@lambrioanpm/expedita-voluptate-voluptatum/dist/minimal/>
...
<p align="center"><img alt="Toolset Diagram" src="https://@lambrioanpm/expedita-voluptate-voluptatum.github.io/protobuf.js/toolset.svg" /></p>
...
```ts
import { load } from "@lambrioanpm/expedita-voluptate-voluptatum"; // respectively "./node_modules/@lambrioanpm/expedita-voluptate-voluptatum"
...
```ts
import { Message, Type, Field, OneOf } from "@lambrioanpm/expedita-voluptate-voluptatum/light"; // respectively "./node_modules/@lambrioanpm/expedita-voluptate-voluptatum/light.js"
...
#### protobuf.js
* [API Documentation](https://@lambrioanpm/expedita-voluptate-voluptatum.github.io/protobuf.js)
